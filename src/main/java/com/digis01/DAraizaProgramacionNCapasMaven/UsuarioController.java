...
//
//    @PostMapping("form")
//    public String Formulario(@ModelAttribute("usuario") Usuario usuario, BindingResult bindingResult, @RequestParam("imagen") MultipartFile imagen, Model model) {
//        Result result = new Result();
//
//        try {
...
//    public String UpdateImagen(@ModelAttribute("usuario") Usuario usuario, BindingResult bindingResult, @PathVariable("IdUsuario") int identificador, @RequestParam("imagen") MultipartFile imagen, Model model) {
//        Result result = new Result();
//        try {
